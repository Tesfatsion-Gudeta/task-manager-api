...
async function bootstrap() {
  ...
  // cors config
  app.enableCors({
    origin: ['http://localhost:8080', 'http://localhost:3000','https://task-flow-seven-beta.vercel.app','http://task-flow-seven-beta.vercel.app','https://task-flow-seven-beta.vercel.app'], // Allowed frontend origins
